// ===================================================================
// ExtraWeb Backend - Configuration File
...
export default {
  ...
  database_url: process.env.DATABASE_URL || 'mongodb://localhost:27017/extrainweb',
  ...
  email: {
    ...
    from: process.env.EMAIL_FROM || 'noreply@extrainweb.com',
  },
