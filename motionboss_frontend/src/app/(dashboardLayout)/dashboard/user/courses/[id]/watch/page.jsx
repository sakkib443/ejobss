        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center space-y-4">
                    <div className="w-14 h-14 border-4 border-[#41bfb8] border-t-transparent rounded-full animate-spin mx-auto"></div>
            ...
            <div className="min-h-screen flex items-center justify-center p-6">
                <div className={`max-w-md w-full p-8 rounded-2xl text-center border ${isDark ? 'bg-slate-800 border-white/10' : 'bg-white border-gray-200 shadow-xl'}`}>
                    ...
                    <button
                        ...
                        className="w-full py-3 bg-[#41bfb8] text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#2dd4bf] transition-all"
                    >
                ...
                <div className="max-w-[1600px] mx-auto px-4 h-14 flex items-center justify-between">
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-xs text-[#41bfb8] font-medium">
                    ...
                    <div className="flex items-center gap-3">
                        {/* Progress Badge */}
                        <div className={`hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg ${isDark ? 'bg-[#41bfb8]/10' : 'bg-[#41bfb8]/10'}`}>
                            <FiTrendingUp size={14} className="text-[#41bfb8]" />
                            <span className="text-xs font-bold text-[#41bfb8]">{progressPercent}% Complete</span>
                        </div>
                        <button
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                                    <div className="space-y-3 flex-1">
                                        ...
                                        <div className="flex flex-wrap items-center gap-2">
                                            <span className="px-2.5 py-1 rounded-lg bg-[#41bfb8]/10 text-[#41bfb8] text-xs font-bold">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-[#41bfb8] to-[#2dd4bf] text-white rounded-xl font-bold text-sm shadow-lg shadow-[#41bfb8]/20 hover:shadow-xl hover:scale-[1.02] active:scale-95 transition-all whitespace-nowrap"
                                    >
                            ...
                            <div className={`p-4 border-b ${isDark ? 'bg-slate-800 border-white/5' : 'bg-gray-50 border-gray-200'}`}>
                                <div className="flex items-center justify-between mb-3">
                                    <h3 className={`font-bold flex items-center gap-2 ${isDark ? 'text-white' : 'text-gray-800'}`}>
                                        <FiBookOpen className="text-[#41bfb8]" size={16} />
                                        Course Content
                                    </h3>
                                    <button
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex items-center justify-between text-xs">
                                        ...
                                        <span className="font-bold text-[#41bfb8]">{progressPercent}%</span>
                                    </div>
