                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="ml-2 px-3 py-2 text-sm font-medium text-[#41bfb8] hover:bg-[#41bfb8]/10 rounded-lg transition"
                        >
                            Today
                        </button>
                    </div>
                ...
                <div className="grid grid-cols-7 gap-2">
                    {weekDates.map((date, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`min-h-[120px] p-3 rounded-xl border ${isToday ? 'border-[#41bfb8] bg-[#41bfb8]/5' : 'border-slate-200 bg-slate-50'
                                    }`}
                            >
                                <div className="text-center mb-2">
                                    <p className="text-xs text-slate-500">{dayNames[index]}</p>
                                    <p className={`text-lg font-bold ${isToday ? 'text-[#41bfb8]' : 'text-slate-700'}`}>
                                        {date.getDate()}
                                    </p>
                                </div>
