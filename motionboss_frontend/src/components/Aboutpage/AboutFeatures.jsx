                ...
                >
                    <div className="p-10 lg:p-12 h-full bg-[#fafafa] dark:bg-[#080808] rounded-[60px] border border-gray-100 dark:border-white/5 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.08)] dark:shadow-[0_40px_100px_-20px_rgba(0,0,0,0.5)] transition-all duration-700 hover:border-teal-500/30 group relative overflow-hidden">
                        ...
                        <div className="flex justify-between items-start mb-10 relative z-10">
                            <div className="w-16 h-16 rounded-3xl bg-white dark:bg-white/5 group-hover:bg-teal-500 flex items-center justify-center transition-all duration-700 shadow-sm group-hover:shadow-teal-500/30">
                                <item.icon className="text-teal-500 group-hover:text-black transition-colors duration-500" size={32} />
                            </div>
                            <span className={`${headingFont} text-5xl font-black text-gray-200/50 dark:text-white/[0.02] group-hover:text-teal-500/10 transition-colors duration-700`}>
                                0{pairIdx * 2 + idx + 1}
                            </span>
                        </div>

                        <div className="relative z-10">
                            <h3 className={`${headingFont} text-3xl font-black text-gray-900 dark:text-white mb-5 tracking-tight group-hover:text-teal-500 transition-colors duration-500`}>
                                {item.title}
                            </h3>
                        ...
                        <div className="mt-10 h-[2px] w-full bg-gray-100 dark:bg-white/5 overflow-hidden relative z-10">
                            <div className="h-full w-0 group-hover:w-full bg-teal-500 transition-all duration-1000 origin-left" />
                        </div>
                    </div>
                </motion.div>
            ))}
    ...
    const features = [
        {
            ...
            title: language === 'bn' ? 'মাস্টার মেন্টর' : 'Expert Mentorship',
            description: 'Direct access to high-impact workflows and professional support systems.',
            color: 'teal'
        },
        {
            icon: LuRocket,
            title: language === 'bn' ? 'প্রজেক্ট বেসড' : 'Project Mastery',
            description: 'Direct access to high-impact workflows and professional support systems.',
            color: 'blue'
        },
        {
            icon: LuShield,
            title: language === 'bn' ? 'সার্টিফিকেট' : 'Elite Certification',
            description: 'Direct access to high-impact workflows and professional support systems.',
            color: 'purple'
        },
        {
            icon: LuHeadphones,
            title: language === 'bn' ? '২৪/৭ সাপোর্ট' : 'Priority Support',
            description: 'Direct access to high-impact workflows and professional support systems.',
            color: 'orange'
        },
        {
            icon: LuInfinity,
            title: language === 'bn' ? 'আজীবন এক্সেস' : 'Edge Curriculum',
            description: 'Direct access to high-impact workflows and professional support systems.',
            color: 'teal'
        },
        {
            icon: LuTrophy,
            title: language === 'bn' ? 'জব এসিস্টেন্স' : 'Career Engine',
            description: 'Direct access to high-impact workflows and professional support systems.',
            color: 'blue'
        },
    ];
                    ...
                    <div className="lg:col-span-4 lg:sticky lg:top-40 h-fit mb-16 lg:mb-0">
                        ...
                        >
                            ...
                            <h2 className={`${headingFont} text-4xl lg:text-6xl font-black text-gray-900 dark:text-white leading-[0.95] tracking-tight mb-8`}>
                                THE <span className="text-teal-500 italic font-serif">SYSTEM</span> <br />
                                FOR YOUR <br />
                                SUCCESS
                            </h2>
                            <p className={`text-base lg:text-lg text-gray-500 dark:text-gray-400 leading-relaxed font-normal ${bengaliClass} mb-10 max-w-xs`}>
                                {language === 'bn'
                                    ? 'আমাদের প্রতিটি ফিচার আপনার ক্যারিয়ারের কথা ভেবে প্রফেশনালভাবে ডিজাইন করা।'
                            ...
                            >
                                <div className="w-10 h-10 rounded-full bg-teal-500 flex items-center justify-center text-black shadow-lg">
                                    <LuTrophy size={18} />
                                </div>
                                <div className="text-left">
                                    <span className={`block text-[10px] font-black uppercase tracking-widest text-teal-600 dark:text-teal-400 leading-none mb-1`}>
                                        Join the elite
                                    </span>
                                ...
                                <div className="ml-2 w-6 h-6 rounded-full border border-gray-200 dark:border-white/20 flex items-center justify-center group-hover/btn:bg-teal-500 group-hover/btn:border-teal-500 transition-all duration-500">
