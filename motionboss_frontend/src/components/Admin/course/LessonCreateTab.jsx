...
export default function LessonCreateTab() {
    ...
    const inputClass = "w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#41bfb8] focus:ring-2 focus:ring-[#41bfb8]/20 outline-none text-sm transition-all bg-white text-gray-700 placeholder:text-gray-400";
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-5">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-lg bg-[#41bfb8]/20 flex items-center justify-center text-[#41bfb8]">
                                <FiBook size={14} />
                            </div>
                            <div>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="flex items-center gap-2 bg-[#41bfb8] hover:bg-[#2dd4bf] text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-all disabled:opacity-50"
                        >
                            <FiPlus size={16} />
            ...
            {createdLessons.length > 0 && (
                <div className="bg-[#41bfb8]/10 border border-[#41bfb8]/30 rounded-xl overflow-hidden">
                    <button
                        onClick={() => setShowCreatedList(!showCreatedList)}
                        className="w-full flex items-center justify-between px-4 py-3 hover:bg-[#41bfb8]/5 transition-colors"
                    >
                        <div className="flex items-center gap-2">
                            <FiCheck className="text-[#41bfb8]" size={16} />
                            <span className="font-semibold text-[#41bfb8] text-sm">
                    ...
                    {showCreatedList && (
                        <div className="px-4 pb-3 border-t border-[#41bfb8]/20 pt-2">
                            <div className="flex flex-wrap gap-2">
                                {createdLessons.map((lesson, idx) => (
                                    <div key={lesson._id || idx} className="flex items-center gap-2 px-3 py-1.5 bg-white rounded-lg border border-gray-200">
                                        ...
                                        <FiCheck className="text-[#41bfb8]" size={12} />
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-3 py-2 rounded-lg border text-sm font-medium transition-all ${formData.lessonType === type.value
                                    ? 'border-[#41bfb8] bg-[#41bfb8] text-white'
                ...
                <div className="flex flex-wrap items-center gap-4 pt-2 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            onChange={handleChange}
                            className="w-4 h-4 rounded border-gray-300 text-[#41bfb8] focus:ring-[#41bfb8]"
                        />
                    ...
                    <div className="flex items-center gap-2 ml-auto">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            min="1"
                            className="w-16 px-2 py-1.5 rounded-lg border border-gray-200 text-sm text-center focus:border-[#41bfb8] outline-none"
                        />
                    </div>
                </div>
            </div>
                    ...
                    {tabs.map(tab => (
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-4 py-3 font-medium text-sm border-b-2 transition-all whitespace-nowrap ${activeTab === tab.id
                                ? 'border-[#41bfb8] text-[#41bfb8] bg-[#41bfb8]/5'
                        ...
                        >
                            ...
                            {tab.label}
                            {tab.badge > 0 && (
                                <span className="ml-1 px-1.5 py-0.5 rounded-full text-xs font-bold bg-[#41bfb8]/20 text-[#41bfb8]">
                                    {tab.badge}
                                </span>
                            )}
                        </button>
                    ...
                    {activeTab === 'questions' && (
                        <div className="space-y-4">
                            ...
                            {formData.questions?.length > 0 && (
                                <div className="mt-4 p-4 bg-[#41bfb8]/10 rounded-xl border border-[#41bfb8]/20 space-y-3">
                                        ...
                                        <div className="flex flex-col justify-center gap-1.5">
                                            <label className="flex items-center gap-2 text-xs">
                                                <input
                                                    ...
                                                    className="w-3.5 h-3.5 rounded border-gray-300 text-[#41bfb8]"
                                                />
                                                Show Answers
                                            </label>
                                            <label className="flex items-center gap-2 text-xs">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                ...
                                <div className="grid grid-cols-4 gap-3 text-center">
                                    ...
                                    <div className="p-2 bg-white rounded-lg">
                                        <p className="text-xl font-bold text-[#41bfb8]">{formData.documents?.length || 0}</p>
