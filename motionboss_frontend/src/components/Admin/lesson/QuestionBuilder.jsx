...
export default function QuestionBuilder({ questions = [], onChange }) {
    ...
    const inputClass = "w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#41bfb8] focus:ring-2 focus:ring-[#41bfb8]/20 outline-none text-sm transition-all bg-white";

    return (
        <div className="space-y-5">

            {/* Header Stats */}
            <div className="bg-gradient-to-r from-[#41bfb8] to-[#2dd4bf] p-5 rounded-2xl text-white">
            ...
            {questions.length > 0 && (
                <div className="space-y-3">
                    ...
                    {questions.map((q, index) => (
                        <div
                            key={index}
                            className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-[#41bfb8]/50 hover:shadow-md transition-all"
                        >
                            <div
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-[#41bfb8] to-[#2dd4bf] text-white flex items-center justify-center font-bold text-lg">
                                        {index + 1}
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            <span className="px-2 py-0.5 bg-[#41bfb8]/10 text-[#41bfb8] rounded text-xs font-medium">
                                ...
                                <div className="flex items-center gap-1">
                                    <button
                                        ...
                                        className="p-2 hover:bg-gray-100 rounded-lg text-gray-500 hover:text-[#41bfb8] transition-colors"
                                    >
                                        <FiEdit3 size={16} />
                                    </button>
                                    <button
            ...
            {showForm ? (
                <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-lg">
                    {/* Form Header */}
                    <div className="bg-gradient-to-r from-[#41bfb8] to-[#2dd4bf] px-5 py-4 text-white flex items-center justify-between">
                    ...
                    <div className="p-5 space-y-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-3">
                                <span className="w-6 h-6 rounded-md bg-[#41bfb8] text-white flex items-center justify-center font-semibold text-xs">1</span>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-2">
                                    <span className="w-6 h-6 rounded-md bg-[#41bfb8] text-white flex items-center justify-center font-semibold text-xs">2</span>
                                ...
                                {formData.options.length < 6 && (
                                    <button
                                        ...
                                        className="flex items-center gap-1.5 text-[#41bfb8] text-xs font-semibold hover:text-[#2dd4bf] px-3 py-1.5 bg-[#41bfb8]/10 rounded-lg transition-colors"
                                    >
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 px-3 py-2 rounded-lg border border-gray-200 focus:border-[#41bfb8] outline-none text-sm bg-white"
                                            />
                                            <input
                                                type="text"
                                                value={opt.textBn}
                                                ...
                                                placeholder="Bengali"
                                                className="w-24 px-3 py-2 rounded-lg border border-gray-200 focus:border-[#41bfb8] outline-none text-sm bg-white"
                                            />
                                        </div>
                                        ...
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all shrink-0 ${opt.isCorrect
                                                ...
                                                : 'bg-white border border-gray-200 text-gray-400 hover:border-[#41bfb8] hover:text-[#41bfb8]'
                                                }`}
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                            ...
                            <button
                                ...
                                className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#41bfb8] to-[#2dd4bf] hover:from-[#2dd4bf] hover:to-[#41bfb8] text-white font-medium text-sm flex items-center gap-2 shadow-md transition-all"
                            >
                                <FiCheck size={16} />
                ...
                <button
                    ...
                    className="w-full p-4 border-2 border-dashed border-[#41bfb8]/40 rounded-xl text-[#41bfb8] hover:border-[#41bfb8] hover:bg-[#41bfb8]/5 transition-all flex items-center justify-center gap-3 font-semibold"
                >
                    <div className="w-10 h-10 rounded-lg bg-[#41bfb8]/10 flex items-center justify-center">
                        <FiPlus size={20} />
                    </div>
                    Add New Question
                </button>
